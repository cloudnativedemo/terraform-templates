...
resource "infoblox_ip_allocation" "ip_allocation"{
  ...
  zone        = var.infoblox_zone
  dns_view    = "default"
  cidr        = var.infoblox_network
  enable_dns  = var.infoblox_enable_dns
  tenant_id   = "test"
}
...
resource "vsphere_virtual_machine" "vm_1" {
  ...
  clone {
    ...
    customize {
      ...
      network_interface {
        ipv4_address = ipv4_address = infoblox_ip_allocation.ip_allocation.ip_addr
